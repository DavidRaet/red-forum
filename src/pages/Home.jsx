...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen ">
      ...
      <input className=' bg-[rgba(147,147,147,0.38)] text-[#222222] font-bold rounded-[1.25rem] w-[440px] h-[4rem] mt-9 text-right pr-6' onChange={handleChange} type="text" placeholder='search...' />
